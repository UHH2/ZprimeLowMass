...
KinFitTestRECOHists::KinFitTestRECOHists(uhh2::Context& ctx, const std::string& dir, const std::string& ttgen, const std::string& hyps, const std::string& disc):
  HistsBASE(ctx, dir) {
...
void KinFitTestRECOHists::init(){
  ...
  book_TH1F("rec_ttbar__gen_DM_genM_0_340"      , 120, -600, 600);
  book_TH1F("rec_ttbar__gen_DM_pct_genM_0_340"  , 120, -1.2, 1.2);
  book_TH1F("rec_ttbar__gen_DM_genM_340_440"      , 120, -600, 600);
  book_TH1F("rec_ttbar__gen_DM_pct_genM_340_440"  , 120, -1.2, 1.2);
  book_TH1F("rec_ttbar__gen_DM_genM_440_540"      , 120, -600, 600);
  book_TH1F("rec_ttbar__gen_DM_pct_genM_440_540"  , 120, -1.2, 1.2);
  book_TH1F("rec_ttbar__gen_DM_genM_540_640"      , 120, -600, 600);
  book_TH1F("rec_ttbar__gen_DM_pct_genM_540_640"  , 120, -1.2, 1.2);
  book_TH1F("rec_ttbar__gen_DM_genM_640_800"      , 120, -600, 600);
  book_TH1F("rec_ttbar__gen_DM_pct_genM_640_800"  , 120, -1.2, 1.2);
  book_TH1F("rec_ttbar__gen_DM_genM_800_1000"      , 120, -600, 600);
  book_TH1F("rec_ttbar__gen_DM_pct_genM_800_1000"  , 120, -1.2, 1.2);
  book_TH1F("rec_ttbar__gen_DM_genM_gr1000"      , 120, -600, 600);
  book_TH1F("rec_ttbar__gen_DM_pct_genM_gr1000"  , 120, -1.2, 1.2);
  book_TH2F("rec_ttbar_M__VS__rec_ttbar__gen_DM", 4000, 0, 4000, 120, -600, 600);
  book_TH2F("gen_ttbar_M__VS__rec_ttbar__gen_DM_pct", 1000, 0, 5000, 120, -3.0, 3.0);
  book_TH2F("gen_ttbar_M__VS__rec_ttbar__gen_DM", 5000, 0, 5000, 120, -600, 600);
...
void KinFitTestRECOHists::fill(const uhh2::Event& event){
...
void  KinFitTestRECOHists::fill(const uhh2::Event& event, const ReconstructionHypothesis* hyp, const float hyp_val, const TTbarGen* ttgen, const double weight){
...
//Reconstruction Hypothesis
  ...
  if(gen_ttbar_M<=340)  H1("rec_ttbar__gen_DM_genM_0_340") ->Fill(rec_ttbar_M - gen_ttbar_M , weight);
  if(gen_ttbar_M>340 && gen_ttbar_M<=440)  H1("rec_ttbar__gen_DM_genM_340_440") ->Fill(rec_ttbar_M - gen_ttbar_M , weight);
  if(gen_ttbar_M>440 && gen_ttbar_M<=540)  H1("rec_ttbar__gen_DM_genM_440_540") ->Fill(rec_ttbar_M - gen_ttbar_M , weight);
  if(gen_ttbar_M>540 && gen_ttbar_M<=640)  H1("rec_ttbar__gen_DM_genM_540_640") ->Fill(rec_ttbar_M - gen_ttbar_M , weight);
  if(gen_ttbar_M>640 && gen_ttbar_M<=800)  H1("rec_ttbar__gen_DM_genM_640_800") ->Fill(rec_ttbar_M - gen_ttbar_M , weight);
  if(gen_ttbar_M>800 && gen_ttbar_M<=1000)  H1("rec_ttbar__gen_DM_genM_800_1000") ->Fill(rec_ttbar_M - gen_ttbar_M , weight);
  if(gen_ttbar_M>1000)  H1("rec_ttbar__gen_DM_pct_genM_gr1000") ->Fill(rec_ttbar_M - gen_ttbar_M , weight);

    if(gen_ttbar_M){
      H1("rec_ttbar__gen_DM_pct") ->Fill((rec_ttbar_M -gen_ttbar_M) /fabs(gen_ttbar_M) , weight);
      if(gen_ttbar_M<=340)  H1("rec_ttbar__gen_DM_pct_genM_0_340") ->Fill(rec_ttbar_M - gen_ttbar_M , weight);
      if(gen_ttbar_M>340 && gen_ttbar_M<=440)  H1("rec_ttbar__gen_DM_pct_genM_340_440") ->Fill(rec_ttbar_M - gen_ttbar_M , weight);
      if(gen_ttbar_M>440 && gen_ttbar_M<=540)  H1("rec_ttbar__gen_DM_pct_genM_440_540") ->Fill(rec_ttbar_M - gen_ttbar_M , weight);
      if(gen_ttbar_M>540 && gen_ttbar_M<=640)  H1("rec_ttbar__gen_DM_pct_genM_540_640") ->Fill(rec_ttbar_M - gen_ttbar_M , weight);
      if(gen_ttbar_M>640 && gen_ttbar_M<=800)  H1("rec_ttbar__gen_DM_pct_genM_640_800") ->Fill(rec_ttbar_M - gen_ttbar_M , weight);
      if(gen_ttbar_M>800 && gen_ttbar_M<=1000)  H1("rec_ttbar__gen_DM_pct_genM_800_1000") ->Fill(rec_ttbar_M - gen_ttbar_M , weight);
      if(gen_ttbar_M>1000)  H1("rec_ttbar__gen_DM_pct_genM_gr1000") ->Fill(rec_ttbar_M - gen_ttbar_M , weight);
    }
    H2("rec_ttbar_M__VS__rec_ttbar__gen_DM")->Fill(rec_ttbar_M, rec_ttbar_M -gen_ttbar_M, weight);
    if(gen_ttbar_pt){
      H1("rec_ttbar__gen_Dpt_pct")->Fill((rec_ttbar_pt-gen_ttbar_pt)/fabs(gen_ttbar_pt), weight);
      H2("gen_ttbar_M__VS__rec_ttbar__gen_DM_pct")->Fill(gen_ttbar_M, (rec_ttbar_M -gen_ttbar_M) /fabs(gen_ttbar_M), weight);
      H2("gen_ttbar_M__VS__rec_ttbar__gen_DM")->Fill(gen_ttbar_M, (rec_ttbar_M -gen_ttbar_M), weight);
    }
    // thad
...
float KinFitTestRECOHists::deltaR_fit(const LorentzVector& p1, const LorentzVector p2){
    float deltaeta = p1.Eta() - p2.Eta();
    float dphi = deltaPhi(p1, p2);
    return sqrt(deltaeta * deltaeta + dphi * dphi);
}

float KinFitTestRECOHists::deltaR_fit_new(const float eta1, const float eta2, const float phi1, const float phi2){
    float deltaeta = eta1 - eta2;
    float dphi = delta_phi(phi1, phi2);
    return sqrt(deltaeta * deltaeta + dphi * dphi);
}

float KinFitTestRECOHists::delta_phi(const float phi1, const float phi2){
...
void KinFitTestRECOHists::boost_x1_to_x2CM(TLorentzVector& x1, const TLorentzVector& x2){
...
float KinFitTestRECOHists::cosThetaX(const LorentzVector& tprod, const LorentzVector& top, const LorentzVector& ttbar0){
...
float KinFitTestRECOHists::cosThetaCS(const LorentzVector& top, const LorentzVector& ttbar0){
...
KinFitTestRECOHists::~KinFitTestRECOHists(){}
